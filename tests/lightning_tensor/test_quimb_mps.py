...
ops = {
    ...
    "CRX": qml.CRX(0.0, wires=[0, 1]),
    "CRY": qml.CRY(0.0, wires=[0, 1]),
    "CRZ": qml.CRZ(0.0, wires=[0, 1]),
    "CRot": qml.CRot(0.0, 0.0, 0.0, wires=[0, 1]),
    ...
    "MultiRZ": qml.MultiRZ(0.0, wires=[0]),
    "PauliX": qml.X(0),
    "PauliY": qml.Y(0),
    "PauliZ": qml.Z(0),
    "X": qml.X([0]),
    "Y": qml.Y([0]),
    "Z": qml.Z([0]),
    "PhaseShift": qml.PhaseShift(0.0, wires=[0]),
    "PCPhase": qml.PCPhase(0.0, 1, wires=[0, 1]),
    "ControlledPhaseShift": qml.ControlledPhaseShift(0.0, wires=[0, 1]),
    "CPhaseShift00": qml.CPhaseShift00(0.0, wires=[0, 1]),
    "CPhaseShift01": qml.CPhaseShift01(0.0, wires=[0, 1]),
    "CPhaseShift10": qml.CPhaseShift10(0.0, wires=[0, 1]),
    ...
    "RX": qml.RX(0.0, wires=[0]),
    "RY": qml.RY(0.0, wires=[0]),
    "RZ": qml.RZ(0.0, wires=[0]),
    "Rot": qml.Rot(0.0, 0.0, 0.0, wires=[0]),
    "S": qml.S(wires=[0]),
    "Adjoint(S)": qml.adjoint(qml.S(wires=[0])),
    "SWAP": qml.SWAP(wires=[0, 1]),
    "ISWAP": qml.ISWAP(wires=[0, 1]),
    "PSWAP": qml.PSWAP(0.0, wires=[0, 1]),
    ...
    "IsingXX": qml.IsingXX(0.0, wires=[0, 1]),
    "IsingYY": qml.IsingYY(0.0, wires=[0, 1]),
    "IsingZZ": qml.IsingZZ(0.0, wires=[0, 1]),
    "IsingXY": qml.IsingXY(0.0, wires=[0, 1]),
    "SingleExcitation": qml.SingleExcitation(0.0, wires=[0, 1]),
    "SingleExcitationPlus": qml.SingleExcitationPlus(0.0, wires=[0, 1]),
    "SingleExcitationMinus": qml.SingleExcitationMinus(0.0, wires=[0, 1]),
    "DoubleExcitation": qml.DoubleExcitation(0.0, wires=[0, 1, 2, 3]),
    "QubitCarry": qml.QubitCarry(wires=[0, 1, 2, 3]),
    "QubitSum": qml.QubitSum(wires=[0, 1, 2]),
    "PauliRot": qml.PauliRot(0.0, "XXYY", wires=[0, 1, 2, 3]),
    "U1": qml.U1(0.0, wires=0),
    "U2": qml.U2(0.0, 0.0, wires=0),
    "U3": qml.U3(0.0, 0.0, 0.0, wires=0),
    "SISWAP": qml.SISWAP(wires=[0, 1]),
    "Adjoint(SISWAP)": qml.adjoint(qml.SISWAP(wires=[0, 1])),
    "OrbitalRotation": qml.OrbitalRotation(0.0, wires=[0, 1, 2, 3]),
    "FermionicSWAP": qml.FermionicSWAP(0.0, wires=[0, 1]),
