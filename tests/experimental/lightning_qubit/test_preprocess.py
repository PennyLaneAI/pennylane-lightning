...
class TestExpandFnValidation:
    ...
    def test_expand_fn_invalid_tensor_observable(self):
        """Test that expand_fn throws an error when a tensor includes invalid observables"""
        tape = QuantumScript(
    ...
    def test_valid_tensor_observable(self):
        """Test that a valid tensor observable passes without error."""
...
class TestPreprocess:
    """Unit tests for preprocess functionality."""

    def test_choose_best_gradient_method(self):
        """Test that preprocessing chooses adjoint as the best gradient method."""
