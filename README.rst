...
|                |           |           |           |           |           |
+================+===========+===========+===========+===========+===========+
| L-Qubit        | pip       | pip       | pip       | pip       | pip       |
+----------------+-----------+-----------+-----------+-----------+-----------+
| L-GPU          | pip       | pip       |           |           |           |
+----------------+-----------+-----------+-----------+-----------+-----------+
| L-GPU (MPI)    | source    |           |           |           |           |
+----------------+-----------+-----------+-----------+-----------+-----------+
| L-Kokkos (OMP) | pip       | pip       | pip       | pip       |           |
+----------------+-----------+-----------+-----------+-----------+-----------+
...
==========
+----------------+-----------+-----------+-----------+-----------+-----------+--------------------------------------------------------------------------------------------------------------------------------------------+
|                | Linux x86 | Linux ARM | MacOS x86 | MacOS ARM | Windows   | Source                                                                                                                                     |
|                |           |           |           |           |           |                                                                                                                                            |
+================+===========+===========+===========+===========+===========+============================================================================================================================================+
| L-Qubit        | pip       | pip       | pip       | pip       | pip       | `lightning.qubit <https://docs.pennylane.ai/projects/lightning/en/stable/lightning_qubit/installation.html>`_                              |
+----------------+-----------+-----------+-----------+-----------+-----------+--------------------------------------------------------------------------------------------------------------------------------------------+
