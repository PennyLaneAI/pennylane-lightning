...
.. code-block:: console
    ...
    cmake -BBuild -DENABLE_CLANG_TIDY=on -DPL_BACKEND=lightning_gpu -DCUQUANTUM_SDK=<path to sdk>
    cmake --build ./Build --verbose
    python -m pip install wheel
    PL_BACKEND="lightning_gpu" python setup.py build_ext --cuquantum=<path to sdk>
    python setup.py bdist_wheel
