...
To enable parallel differentiation over observables, ensure the ``OMP_NUM_THREADS`` environment variable is set before starting ypur Python session, or if already started, before importing your packages:
