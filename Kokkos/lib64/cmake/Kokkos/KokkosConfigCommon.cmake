...
set(Kokkos_OPTIONS DEPRECATED_CODE_5;DEPRECATION_WARNINGS;DEBUG_DUALVIEW_MODIFY_CHECK;IMPL_HIP_MALLOC_ASYNC;IMPL_REF_COUNT_BRANCH_UNLIKELY;IMPL_MDSPAN)
set(Kokkos_TPLS ROCTHRUST)
set(Kokkos_ARCH AMD_GFX942)
set(Kokkos_CXX_COMPILER "/opt/rocm/bin/hipcc")
set(Kokkos_CXX_COMPILER_ID "HIPCC")
set(Kokkos_CXX_COMPILER_VERSION "7.0.51831")
...
if(Kokkos_ENABLE_HIP)
  set(Kokkos_HIP_ARCHITECTURES gfx942)
endif()
...
function(kokkos_compilation)
  ...
  set(_HINTS "${CMAKE_CURRENT_FUNCTION_LIST_DIR}/../../.." "/root/Kokkos_install/rocm")
