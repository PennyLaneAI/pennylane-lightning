...
include("${CMAKE_CURRENT_LIST_DIR}/FindSCIPY_OPENBLAS32.cmake")
if(NOT SETUP_PY_BUILD)
    set(SCIPY_OPENBLAS32_LIB_PATH "" CACHE STRING "Path to the scipy_openblas32 library")
    ...
    message(STATUS "SETUP_PY_BUILD is ON. SCIPY_OPENBLAS32_LIB_PATH is not set.")
endif()