...
if(ENABLE_LAPACK)
    if(NOT MSVC OR CMAKE_TOOLCHAIN_FILE)
        ...
        if(Lapack_FOUND)
            ...
            target_link_libraries(lightning_external_libs INTERFACE ${pennylane_lightning_SOURCE_DIR}/LAPACK/lib/liblapack.a)
            target_link_libraries(lightning_external_libs INTERFACE ${pennylane_lightning_SOURCE_DIR}/LAPACK/lib/libblas.a)
            target_compile_options(lightning_compile_options INTERFACE "-DPL_USE_LAPACK=1")
        else()
