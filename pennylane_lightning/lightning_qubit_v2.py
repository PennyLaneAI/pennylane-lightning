...
class LightningQubit(QubitDevice):
    ...
    def apply(self, operations, rotations=None, **kwargs):
        ...
        # print("self._pre_rotated_state", self._pre_rotated_state)
        # print("self._state", self._state)
    ...
    def probability(self, wires=None, shot_range=None, bin_size=None):
        ...
        # dim = 1 << self.num_wires
        # batch_size = self._get_batch_size(self._state, (dim,)* self.num_wires, dim)
        # batched_states = self._state if batch_size else [self._state,]
