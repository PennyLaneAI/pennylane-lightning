 ...
 * @return nb::ndarray<VectorT, nb::numpy, nb::c_contig> Array with copied data in numpy format
 */
 ...
 * @tparam VectorT Data type of the vector elements
 * @param data Vector containing the data to transfer
 * @return nb::ndarray<VectorT, nb::numpy, nb::c_contig> 1D array with copied data
 */
template <typename VectorT>
nb::ndarray<VectorT, nb::numpy, nb::c_contig>
createNumpyArrayFromVector(const std::vector<VectorT> &data) {
 ...
 * @return nb::ndarray<VectorT, nb::numpy, nb::c_contig> 2D array with copied data
 */
template <typename VectorT>
nb::ndarray<VectorT, nb::numpy, nb::c_contig>
createNumpyArrayFromVector(const std::vector<VectorT> &data, 
...
convertMatrices(const std::vector<nb::ndarray<const std::complex<ParamT>, nb::c_contig>> &matrices) {
...
std::string opsDataToString(const OpsDataT &ops, bool include_controlled = true) {
