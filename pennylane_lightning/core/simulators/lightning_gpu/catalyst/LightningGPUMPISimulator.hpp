...
/**
 * @file LightningGPUMPISimulator.hpp
 */
 ...
 *
 */
class LightningGPUMPISimulator final : public Catalyst::Runtime::QuantumDevice {
  private:
    using StateVectorT =
        Pennylane::LightningGPU::StateVectorCudaMPI<double>;
  ...
  public:
    explicit LightningGPUMPISimulator(const std::string &kwargs = "{}") {
        auto &&args = Catalyst::Runtime::parse_kwargs(kwargs);
    }
    ~LightningGPUMPISimulator() = default;

    LightningGPUMPISimulator(const LightningGPUMPISimulator &) = delete;
    LightningGPUMPISimulator &operator=(const LightningGPUMPISimulator &) = delete;
    LightningGPUMPISimulator(LightningGPUMPISimulator &&) = delete;
    LightningGPUMPISimulator &operator=(LightningGPUMPISimulator &&) = delete;
