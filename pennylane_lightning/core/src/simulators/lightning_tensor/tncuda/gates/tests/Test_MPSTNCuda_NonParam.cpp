    ...
    const bool inverse = GENERATE(true, false);
    {
        ...
        SECTION("Apply using dispatcher") {
            for (std::size_t index = 0; index < num_qubits; index++) {
                MPSTNCuda<TestType> sv{num_qubits, maxExtent, qubitDims, dev_tag};
...
TEMPLATE_TEST_CASE("StateVectorCudaManaged::applyPauliY",
    ...
    const bool inverse = false; // GENERATE(true, false);
    {
        ...
        SECTION("Apply using dispatcher") {
            ...
            for (std::size_t index = 0; index < num_qubits; index++) {
                MPSTNCuda<TestType> sv_init{num_qubits, maxExtent, qubitDims,
                                          dev_tag};
...
TEMPLATE_TEST_CASE("MPSTNCuda::applyPauliZ", "[MPSTNCuda_Nonparam]", float,
    ...
    const bool inverse = GENERATE(true, false);
    {
        ...
        SECTION("Apply using dispatcher") {
            for (std::size_t index = 0; index < num_qubits; index++) {
                MPSTNCuda<TestType> sv_dispatch(sv);
...
TEMPLATE_TEST_CASE("MPSTNCuda::applyCNOT", "[MPSTNCuda_Nonparam]", float, double) {
    const bool inverse = GENERATE(true, false);
    {
        std::size_t num_qubits = 3;
        std::size_t maxExtent = 2;
...
TEMPLATE_TEST_CASE("MPSTNCuda::applySWAP", "[MPSTNCuda_Nonparam]", float, double) {
    const bool inverse = GENERATE(true, false);
    {
        using cp_t = std::complex<TestType>;
        std::size_t num_qubits = 3;
        ...
        SECTION("Apply using dispatcher") {
            SECTION("SWAP0,1 |+10> -> |1+0>") {
                ...
                MPSTNCuda<TestType> sv01(sv);
                MPSTNCuda<TestType> sv10(sv);
            ...
            SECTION("SWAP0,2 |+10> -> |01+>") {
                ...
                MPSTNCuda<TestType> sv02(sv);
                MPSTNCuda<TestType> sv20(sv);
            ...
            SECTION("SWAP1,2 |+10> -> |+01>") {
                ...
                MPSTNCuda<TestType> sv12(sv);
                MPSTNCuda<TestType> sv21(sv);
...
// NOLINTNEXTLINE: Avoiding complexity errors
TEMPLATE_TEST_CASE("MPSTNCuda::applyCY", "[MPSTNCuda_Nonparam]", float, double) {
    const bool inverse = GENERATE(true, false);
    {
        using cp_t = std::complex<TestType>;
        std::size_t num_qubits = 3;
...
// NOLINTNEXTLINE: Avoiding complexity errors
TEMPLATE_TEST_CASE("MPSTNCuda::applyCZ", "[MPSTNCuda_Nonparam]", float, double) {
    const bool inverse = GENERATE(true, false);
    {
        using cp_t = std::complex<TestType>;
        std::size_t num_qubits = 3;
    ...
    const bool inverse = GENERATE(true, false);
    {
        ...
        SECTION("Apply using dispatcher") {
            SECTION("Toffoli [0,1,2], [1,0,2] |+10> -> |+1+>") {
                ...
                MPSTNCuda<TestType> sv012(sv);
                MPSTNCuda<TestType> sv102(sv);
...
// NOLINTNEXTLINE: Avoiding complexity errors
TEMPLATE_TEST_CASE("MPSTNCuda::applyCSWAP", "[MPSTNCuda_Nonparam]", float, double) {
    const bool inverse = GENERATE(true, false);
    {
        using cp_t = std::complex<TestType>;
        SECTION("Apply using dispatcher") {
...
TEMPLATE_TEST_CASE("MPSTNCuda::SetIthStates", "[MPSTNCuda_Nonparam]", float,
                   double) {
    std::size_t num_qubits = 3;
    std::size_t maxExtent = 2;
    std::vector<size_t> qubitDims = {2, 2, 2};
