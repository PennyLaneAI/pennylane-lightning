...
using TestTNBackends = Pennylane::Util::TypeList<MPSTNCuda<float>, MPSTNCuda<double>, ExaTNCuda<float>, ExaTNCuda<double>>;
// using TestTNBackends = Pennylane::Util::TypeList<MPSTNCuda<float>, MPSTNCuda<double>>;

TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::Identity", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        ...
        if constexpr (std::is_same_v<TestType, MPSTNCuda<double>> || std::is_same_v<TestType, MPSTNCuda<float>>)
        {
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::Hadamard", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::PauliX", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::applyOperation-gatematrix",
                   "[MPSTNCuda_Nonparam]", TestTNBackends) {
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::PauliY", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
        ...
        const cp_t p = cuUtil::ConstMult(
            cp_t(0.5, 0.0),
            cuUtil::ConstMult(cuUtil::INVSQRT2<cp_t>(),
                              cuUtil::IMAG<cp_t>()));
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::PauliZ", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
        ...
        const cp_t p(cp_t(0.5, 0.0) *
                     cuUtil::INVSQRT2<cp_t>());
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::S", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::T", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::CNOT", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::SWAP", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
        ...
        SECTION("Apply adjacent wire indices") {
            std::vector<cp_t> expected{cuUtil::ZERO<cp_t>(),
                                       cuUtil::ZERO<cp_t>(),
                                       cuUtil::ZERO<cp_t>(),
                                       cuUtil::ZERO<cp_t>(),
                                       cp_t(1.0 / sqrt(2), 0),
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::CY", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::Gates::CZ", "[MPSTNCuda_Nonparam]", TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        using cp_t = typename TNDevice_T::ComplexT;
...
TEMPLATE_LIST_TEST_CASE("ExaTNCuda::Gates::CSWAP", "[ExaTNCuda_Nonparam]", TestTNBackends)
{
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
...
TEMPLATE_LIST_TEST_CASE("ExaTNCuda::Gates::Toffoli", "[ExaTNCuda_Nonparam]", TestTNBackends)
{
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::applyControlledOperation non-param "
    ...
    {
        // Create the object for MPSTNCuda
        tn_state0 = std::make_unique<TNDevice_T>(num_qubits, maxExtent, dev_tag);
        tn_state1 = std::make_unique<TNDevice_T>(num_qubits, maxExtent, dev_tag);
        }
        else
        {
            // Create the object for ExaTNCuda
...
TEMPLATE_LIST_TEST_CASE("MPSTNCuda::applyMPO::2+_wires", "[MPSTNCuda_NonParam]",
                   TestTNBackends) {
    const bool inverse = GENERATE(false, true);
    {
        using TNDevice_T = TestType;
        ...
        SECTION("Tests for 3-wire MPOs") {
            ...
            if constexpr (std::is_same_v<TestType, ExaTNCuda<double>> || std::is_same_v<TestType, ExaTNCuda<float>>)
            {
                tn_state->applyOperation("CSWAP", {0, 1, 2}, inverse);
            }
