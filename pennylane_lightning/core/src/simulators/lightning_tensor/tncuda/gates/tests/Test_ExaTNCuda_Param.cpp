...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::PhaseShift", "[ExaTNCuda_Param]", float,
                   double) {
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::RX", "[ExaTNCuda_Param]", float, double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
        std::size_t num_qubits = 3;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::RY", "[ExaTNCuda_Nonparam]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::RZ", "[ExaTNCuda_Param]", float, double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
        std::size_t num_qubits = 3;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::ControlledPhaseShift",
                   "[ExaTNCuda_Param]", float, double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
        std::size_t num_qubits = 3;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::Rot", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
        ...
        SECTION("Apply at different wire indices") {
            ...
            exatn_state.applyOperation("Rot", {index}, inverse, angles[index]);
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::CRot", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
        ...
        SECTION("Apply adjacent wires") {
            ...
            exatn_state.applyOperation("CRot", {0, 1}, inverse, angles);
        ...
        SECTION("Apply non-adjacent wires") {
            ...
            exatn_state.applyOperation("CRot", {0, 2}, inverse, angles);
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::IsingXX", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::IsingXY", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::IsingYY", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::IsingZZ", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::CRX", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::CRY", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::CRZ", "[ExaTNCuda_param]", float,
                   double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::SingleExcitation", "[ExaTNCuda_param]",
                   float, double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::SingleExcitationMinus",
                   "[ExaTNCuda_param]", float, double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
...
TEMPLATE_TEST_CASE("ExaTNCuda::Gates::SingleExcitationPlus",
                   "[ExaTNCuda_param]", float, double) {
    const bool inverse = GENERATE(false, true);
    {
        using cp_t = std::complex<TestType>;
