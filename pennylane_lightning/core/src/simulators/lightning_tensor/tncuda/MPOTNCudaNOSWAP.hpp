 ...
 */
template <class PrecisionT> class MPOTNCudaNOSWAP {
  private:
  ...
  public:
    explicit MPOTNCudaNOSWAP(const std::vector<std::vector<ComplexT>> &tensors,
        ...
        // copy the wires to MPO_modes_int32_
        std::copy(wires.begin(), wires.end(), MPO_modes_int32_.begin());
        ...
        // // print the MPO_modes_int32_
        // std::cout << "MPO_modes_int32_: ";
        // for (const auto &mode : MPO_modes_int32_)
        // {
        //     std::cout << mode << ", ";
        // }
        // std::cout << std::endl;
