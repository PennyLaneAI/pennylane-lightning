...
auto probs_core(const std::size_t num_data,
    ...
    PROBS_CORE_DECLARE(15)
    PROBS_CORE_DECLARE(16)
    PROBS_CORE_DECLARE(17)
    PROBS_CORE_DECLARE(18)
    PROBS_CORE_DECLARE(19)
    PROBS_CORE_DECLARE(20)
    PROBS_CORE_DECLARE(21)
    PROBS_CORE_DECLARE(22)
    PROBS_CORE_DECLARE(23)
    PROBS_CORE_DECLARE(24)
    PROBS_CORE_DECLARE(25)
    PROBS_CORE_DECLARE(26)
    PROBS_CORE_DECLARE(27)
    PROBS_CORE_DECLARE(28)
    PROBS_CORE_DECLARE(29)
