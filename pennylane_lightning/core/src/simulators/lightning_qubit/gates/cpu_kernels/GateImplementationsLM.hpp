...
class GateImplementationsLM : public PauliGenerator<GateImplementationsLM> {
  private:
    ...
    revWireParityN(const std::array<std::size_t, wire_size> &wire_list)
    ...
    static auto revWireParityM(const std::vector<std::size_t> &wire_list)
  ...
  public:
    ...
    applySingleQubitOp(std::complex<PrecisionT> *arr, size_t num_qubits,
        ...
        const auto parities =
            revWireParityN(std::array<std::size_t, 1>{rev_wire});
    ...
    applyMultiQubitOp(std::complex<PrecisionT> *arr, std::size_t num_qubits,
        ...
        const std::vector<std::size_t> parity = revWireParityM(rev_wires);
