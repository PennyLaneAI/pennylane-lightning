...
auto LightningKokkosSimulator::AllocateQubits(size_t num_qubits)
...
void LightningKokkosSimulator::SetDeviceShots(size_t shots) {
    this->device_shots = shots;
}

auto LightningKokkosSimulator::GetDeviceShots() const -> size_t {
