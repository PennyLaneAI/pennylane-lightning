...
TEMPLATE_TEST_CASE("StateVectorKokkos::applyOperation non-param "
    ...
    SECTION("2-controlled PauliY") {
            ...
            sv_gate.applyOperation("PauliY", control_wires, control_values, target_wire, inverse);
            auto sv_gate_host = Kokkos::create_mirror_view_and_copy(
                Kokkos::HostSpace{}, sv_gate.getView());
        ...
        SECTION("2-controlled PauliZ") {
            ...
            const std::vector<bool> control_values = {true, false};
            const std::vector<std::size_t> target_wire = {1};
            sv_gate.applyOperation("PauliZ", control_wires, control_values, target_wire, inverse);
            auto sv_gate_host = Kokkos::create_mirror_view_and_copy(
                Kokkos::HostSpace{}, sv_gate.getView());
        ...
        SECTION("2-controlled Hadamard") {
            ...
            const std::vector<bool> control_values = {true, false};
            const std::vector<std::size_t> target_wire = {1};
            sv_gate.applyOperation("Hadamard", control_wires, control_values, target_wire, inverse);
            auto sv_gate_host = Kokkos::create_mirror_view_and_copy(
                Kokkos::HostSpace{}, sv_gate.getView());
    ...
    SECTION("2-controlled S") {
            ...
            const std::vector<bool> control_values = {true, false};
            const std::vector<std::size_t> target_wire = {1};
            sv_gate.applyOperation("S", control_wires, control_values, target_wire, inverse);
            auto sv_gate_host = Kokkos::create_mirror_view_and_copy(
                Kokkos::HostSpace{}, sv_gate.getView());
    ...
    SECTION("2-controlled T") {
            ...
            const std::vector<bool> control_values = {true, false};
            const std::vector<std::size_t> target_wire = {1};
            sv_gate.applyOperation("T", control_wires, control_values, target_wire, inverse);
            auto sv_gate_host = Kokkos::create_mirror_view_and_copy(
                Kokkos::HostSpace{}, sv_gate.getView());
