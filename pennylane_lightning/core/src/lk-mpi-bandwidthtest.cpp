...
int main(int argc, char *argv[]) {
    ...
    std::cout << "Average time for swapping "  << average_time << " ms (My rank:"<< my_rank << " dest rank:" << dest_rank << ")" << std::endl;  
    std::cout << "Data sent = Data received = " << data_sent_GB << " GB (My rank:"<< my_rank << " dest rank:" << dest_rank << ")" << std::endl;  
    std::cout << "Effective single direction bandwidth = " << data_sent_GB/average_time*1000.0 << " GB/s (My rank:"<< my_rank << " dest rank:" << dest_rank << ")" << std::endl;  
