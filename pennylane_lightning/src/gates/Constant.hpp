...
[[maybe_unused]] constexpr std::array default_kernel_for_gates = {
    ...
    std::pair{GateOperation::SingleExcitation, KernelType::LM},
    std::pair{GateOperation::SingleExcitationMinus, KernelType::LM},
    std::pair{GateOperation::SingleExcitationPlus, KernelType::LM},
    ...
    std::pair{GateOperation::DoubleExcitation, KernelType::PI},
    std::pair{GateOperation::DoubleExcitationMinus, KernelType::PI},
    std::pair{GateOperation::DoubleExcitationPlus, KernelType::PI},
...
[[maybe_unused]] constexpr std::array default_kernel_for_generators = {
    ...
    std::pair{GeneratorOperation::SingleExcitation, KernelType::LM},
    std::pair{GeneratorOperation::SingleExcitationMinus, KernelType::LM},
    std::pair{GeneratorOperation::SingleExcitationPlus, KernelType::LM},
    std::pair{GeneratorOperation::DoubleExcitation, KernelType::PI},
