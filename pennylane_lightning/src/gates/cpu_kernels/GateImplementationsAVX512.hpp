...
class GateImplementationsAVX512
  ...
  public:
    ...
    static void applyCZ(std::complex<PrecisionT> *arr, const size_t num_qubits,
        ...
        const AVX::TwoQubitGateWithoutParamHelper<ApplyCZAVX512> gate_helper(
    ...
    applySWAP(std::complex<PrecisionT> *arr, const size_t num_qubits,
        ...
        const AVX::TwoQubitGateWithoutParamHelper<ApplySWAPAVX512> gate_helper(
    ...
    applyCNOT(std::complex<PrecisionT> *arr, const size_t num_qubits,
        ...
        using ApplyCNOTAVX512 =
            AVX::ApplyCNOT<PrecisionT, packed_bytes / sizeof(PrecisionT)>;

        static_assert(AVX::AsymmetricTwoQubitGateWithoutParam<ApplyCNOTAVX512>);
        ...
        const AVX::TwoQubitGateWithoutParamHelper<ApplyCNOTAVX512> gate_helper(
    ...
    static void applyIsingXX(std::complex<PrecisionT> *arr,
        ...
        const AVX::TwoQubitGateWithParamHelper<ApplyIsingXXAVX512, ParamT>
            gate_helper(
    ...
    static void applyIsingYY(std::complex<PrecisionT> *arr,
        ...
        const AVX::TwoQubitGateWithParamHelper<ApplyIsingYYAVX512, ParamT>
            gate_helper(
    ...
    static void applyIsingZZ(std::complex<PrecisionT> *arr,
        ...
        const AVX::TwoQubitGateWithParamHelper<ApplyIsingZZAVX512, ParamT>
            gate_helper(
