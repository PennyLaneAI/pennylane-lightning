...
namespace Internal {
    ...
    constexpr auto ExternalInternalFunctions()->decltype(auto) {
        ...
        return ExternalInternalFunctions_Iter<PrecisionT, packed_size>(
            std::make_index_sequence<internal_wires>());
    }
} // namespace Internal

template <SymmetricTwoQubitGateWithoutParam AVXImpl> class TwoQubitGateHelper {
  public:
  ...
  public:
    explicit TwoQubitGateHelper(FuncType fallback_func)
