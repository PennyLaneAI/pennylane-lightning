...
tuple<INDICES, INDICES> get_new_qubit_list(const INDICES &first_control_wires, const INDICES &first_target_wires, const INDICES &second_control_wires, const
...
void optimize_light(vector<unique_ptr<AbstractGate>> && gate_list, vector<string>& labels, const UINT qubit_count);
