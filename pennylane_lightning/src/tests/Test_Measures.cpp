...
TEST_CASE("Probabilities", "[Measures]") {
    // Probabilities calculated with Pennylane default_qbit:
     std::vector<std::vector<double>> Expected_Probabilities={
        {0.687573, 0.013842, 0.089279, 0.001797, 0.180036, 0.003624, 0.023377, 0.000471},//probs(0,1,2)
        {0.687573, 0.180036, 0.089279, 0.023377, 0.013842, 0.003624, 0.001797, 0.000471},//probs(2,1,0)
        {0.687573, 0.180036, 0.013842, 0.003624, 0.089279, 0.023377, 0.001797, 0.000471},//probs(2,0,1)
        {0.687573, 0.089279, 0.180036, 0.023377, 0.013842, 0.001797, 0.003624, 0.000471},// probs(1,2,0)
