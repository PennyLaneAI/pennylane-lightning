...
/**
 * @brief Cache for data generated by the static generateBitPatterns function.
 */
static LRU_cache<std::pair<const std::vector<size_t>, size_t>,
                 std::vector<size_t>>
    cache_BitPatterns_;

/**
 * @brief Cache for data generated by the static getIndicesAfterExclusion
 * function.
 */
static LRU_cache<std::pair<const std::vector<size_t>, size_t>,
                 std::vector<size_t>>
  ...
  public:
    ...
    vector<size_t> static getIndicesAfterExclusion(
        ...
        if (element_it == cache_IndicesAfterExclusion_.end()) {
            ...
            cache_IndicesAfterExclusion_.insert(
                {indicesToExclude, num_qubits},
    ...
    generateBitPatterns(const vector<size_t> &qubitIndices, size_t num_qubits) {
        auto element_it =
            cache_BitPatterns_.check_cache({qubitIndices, num_qubits});
        if (element_it == cache_BitPatterns_.end()) {
            ...
            cache_BitPatterns_.insert({qubitIndices, num_qubits}, indices);
            return indices;
        }
