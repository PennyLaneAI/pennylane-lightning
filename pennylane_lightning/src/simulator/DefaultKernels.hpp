...
[[maybe_unused]] constexpr std::array default_kernel_for_gates = {
    ...
    std::pair{Gates::GateOperation::SingleExcitation, Gates::KernelType::LM},
    std::pair{Gates::GateOperation::SingleExcitationMinus, Gates::KernelType::LM},
    std::pair{Gates::GateOperation::SingleExcitationPlus, Gates::KernelType::LM},
    std::pair{Gates::GateOperation::Toffoli, Gates::KernelType::PI},
    std::pair{Gates::GateOperation::CSWAP, Gates::KernelType::PI},
    std::pair{Gates::GateOperation::DoubleExcitation, Gates::KernelType::PI},
    std::pair{Gates::GateOperation::DoubleExcitationMinus, Gates::KernelType::PI},
    std::pair{Gates::GateOperation::DoubleExcitationPlus, Gates::KernelType::PI},
...
[[maybe_unused]] constexpr std::array default_kernel_for_generators = {
    ...
    std::pair{Gates::GeneratorOperation::ControlledPhaseShift,
              Gates::KernelType::LM},
    std::pair{Gates::GeneratorOperation::SingleExcitation, Gates::KernelType::LM},
    std::pair{Gates::GeneratorOperation::SingleExcitationMinus, Gates::KernelType::LM},
    std::pair{Gates::GeneratorOperation::SingleExcitationPlus, Gates::KernelType::LM},
    std::pair{Gates::GeneratorOperation::DoubleExcitation, Gates::KernelType::PI},
    std::pair{Gates::GeneratorOperation::DoubleExcitationMinus, Gates::KernelType::PI},
    std::pair{Gates::GeneratorOperation::DoubleExcitationPlus, Gates::KernelType::PI},
