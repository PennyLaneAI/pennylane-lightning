...
[[maybe_unused]] constexpr std::array default_kernel_for_gates = {
    ...
    std::pair{Gates::GateOperation::Hadamard, Gates::KernelType::PI},
    std::pair{Gates::GateOperation::S, Gates::KernelType::LM},
    std::pair{Gates::GateOperation::T, Gates::KernelType::LM},
    std::pair{Gates::GateOperation::RX, Gates::KernelType::PI},
    std::pair{Gates::GateOperation::RY, Gates::KernelType::PI},
    ...
    std::pair{Gates::GateOperation::CY, Gates::KernelType::PI},
    ...
    std::pair{Gates::GateOperation::CRot, Gates::KernelType::PI},
...
[[maybe_unused]] constexpr std::array default_kernel_for_generators = {
    ...
    std::pair{Gates::GeneratorOperation::CRX, Gates::KernelType::PI},
    std::pair{Gates::GeneratorOperation::CRY, Gates::KernelType::PI},
    std::pair{Gates::GeneratorOperation::CRZ, Gates::KernelType::PI},
