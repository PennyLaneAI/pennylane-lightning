...
r"""
This module contains the :class:`~.LightningQubitOld` class, a PennyLane simulator device that
...
if LQ_CPP_BINARY_AVAILABLE:
    ...
    class LightningQubitOld(LightningBase):
        ...
        def expval(self, observable, shot_range=None, bin_size=None):
            ...
            if self.shots is not None:
                ...
                # LightningQubitOld doesn't support sampling yet
    ...
    class LightningQubitOld(LightningBaseFallBack):  # pragma: no cover
