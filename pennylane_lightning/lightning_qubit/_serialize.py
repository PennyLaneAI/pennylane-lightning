...
class QuantumScriptSerializer:
    ...
    def _sparse_hamiltonian(self, observable):
        ...
        return self.sparse_hamiltonian_obs(data, indices, offsets, observable.wires.tolist())
    ...
    def _ob(self, observable):
        ...
        if observable.name == "SparseHamiltonian":
            return self._sparse_hamiltonian(observable)
    ...
    def serialize_ops(
        ...
        Returns:
            ...
            a list of inverses, a list of matrices for the operations that do not have a
            dedicated kernel, a list of controlled wires and a list of controlled values.
        """
        names = []
        params = []
        controlled_wires = []
        ...
        for operation in tape.operations:
            ...
            for single_op in op_list:
                ...
                controlled_wires.append(list(controlled_wires_list))
